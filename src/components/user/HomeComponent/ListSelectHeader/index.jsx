  ...
  return (
    ...
    >
      <Box component="div" className="flex justify-around w-[80%]">
        <Box
          component="div"
          className="flex flex-col items-center hover:text-[#15d1c8]"
        >
          <div className="w-[50px] h-[50px] bg-white items-center justify-center flex rounded-[50%] shadow-[0px_1px_2px_rgba(0,0,0,0.5)]">
