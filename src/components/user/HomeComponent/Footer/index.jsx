...
const Footer = () => {
  return (
    <>
              ...
              <li className='flex items-center mb-[12px]'>
                <div>
                  <img
                    src={fb}
                    alt=''
                    className='w-[24px] mr-[8px] hover:mt-[-4px] hover:duration-300 hover:shadow-[0px_20px_20px_rgba(21,209,200,0.13)] hover:w-[30px]'
                  />
                </div>
              ...
              <li className='flex items-center mb-[12px]'>
                <div>
                  <img
                    src={youtube}
                    alt=''
                    className='w-[24px] mr-[8px] hover:duration-200 hover:shadow-[0px_20px_20px_rgba(21,209,200,0.13)] hover:w-[30px]'
                  />
                </div>
                <div className='hover:text-[#097c9f] cursor-pointer'>
                  Youtube
              ...
              <li className='flex items-center mb-[12px]'>
                <div>
                  <img
                    src={linkedIn}
                    alt=''
                    className='w-[24px] mr-[8px] hover:duration-300 hover:shadow-[0px_20px_20px_rgba(21,209,200,0.13)] hover:w-[30px]'
                  />
                </div>
                <div className='hover:text-[#097c9f] cursor-pointer'>
                  Linked
      ...
      <div className='bg-[#056c70] py-[20px] flex items-center'>
        <div className='text-white m-auto text-[13px]'>© 2023 TeleAppoint</div>
      </div>
    </>
  );
};
